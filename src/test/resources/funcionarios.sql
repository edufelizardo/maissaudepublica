...
INSERT INTO endereco (cep, logradouro, numero, complemento, bairro, localidade, uf, ibge, gia, ddd, siafi)
VALUES
  ('01001-000', 'Praça da Sé', 1, '', 'Sé', 'São Paulo', 'SP', '3550308', '1004', '11', '7107'),
  ('01002-000', 'Praça Clóvis Beviláqua', 1, '', 'Sé', 'São Paulo', 'SP', '3550308', '1004', '11', '7107'),
  ('01003-000', 'Viaduto Santa Ifigênia', 1, '', 'Santa Ifigênia', 'São Paulo', 'SP', '3550308', '1004', '11', '7107'),
  ('01004-000', 'Rua Florêncio de Abreu', 1, '', 'Centro', 'São Paulo', 'SP', '3550308', '1004', '11', '7107'),
  ('01005-000', 'Viaduto do Chá', 15, '', 'Centro', 'São Paulo', 'SP', '3550308', '1004', '11', '7107'),
  ('01006-000', 'Rua Boa Vista', 1, '', 'Centro', 'São Paulo', 'SP', '3550308', '1004', '11', '7107'),
  ('01007-000', 'Praça da República', 1, '', 'República', 'São Paulo', 'SP', '3550308', '1004', '11', '7107'),
  ('01008-000', 'Avenida Ipiranga', 165, '', 'República', 'São Paulo', 'SP', '3550308', '1004', '11', '7107'),
  ('01009-000', 'Rua da Consolação', 358, '', 'Consolação', 'São Paulo', 'SP', '3550308', '1004', '11', '7107'),
  ('01010-000', 'Rua Xavier de Toledo', 1, '', 'Centro', 'São Paulo', 'SP', '3550308', '1004', '11', '7107');

INSERT INTO pessoa (nome_completo, data_de_nascimento, cpf, email, address_id)
VALUES
    ('João Silva', '1985-05-20', '123.456.789-00', 'joao.silva@test.com', 1),
    ('Maria Santos', '1990-02-15', '987.654.321-00', 'maria.santos@test.com', 2),
    ('Pedro Almeida', '1978-12-10', '456.789.123-00', 'pedro.almeida@test.com', 3),
    ('Carla Souza', '1987-06-30', '789.123.456-00', 'carla.souza@test.com', 4),
    ('Lucas Mendes', '1995-03-25', '654.321.987-00', 'lucas.mendes@test.com', 5),
    ('Juliana Oliveira', '1980-08-12', '321.789.456-00', 'juliana.oliveira@test.com', 6),
    ('Marcelo Santos', '1983-11-05', '987.654.321-00', 'marcelo.santos@test.com', 7),
    ('Camila Silva', '1992-09-22', '456.789.123-00', 'camila.silva@test.com', 8),
    ('Fernando Alves', '1975-04-18', '789.123.456-00', 'fernando.alves@test.com', 9),
    ('Mariana Costa', '1988-07-01', '654.321.987-00', 'mariana.costa@test.com', 10);
